/**
 * @author Luuxis
 * Luuxis License v1.0 (ver archivo LICENSE para detalles en FR/EN)
 */
        ...
        if (news) {
                ...
                blockNews.innerHTML = `
                    <div class="news-header">
                        ...
                        <div class="header-text">
                            <div class="title">No hay noticias disponibles en este momento.</div>
                        </div>
                        <div class="date">
                    ...
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>Acá vas a poder seguir todas las novedades del servidor.</p>
                        </div>
                    </div>`
            ...
            blockNews.innerHTML = `
                <div class="news-header">
                    ...
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>No se pudo conectar con el servidor de noticias.</br>Por favor, revisá tu configuración.</p>
                        </div>
                    </div>`
            newsElement.appendChild(blockNews);
        }
